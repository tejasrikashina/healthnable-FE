...
@Component({
  ...
  standalone: true,
  imports: [TranslateModule,TextAreaComponent,SelectComponent, PrimeNGModule, MaterialModule, FormsModule, ReactiveFormsModule, InputComponent,HeaderComponent,StatusComponent],
