...
@Component({
  ...
  standalone: true,
  imports: [SelectComponent,MaterialModule,TextAreaComponent,StatusComponent, HeaderComponent, TranslateModule,ReactiveFormsModule,InputComponent, PrimeNGModule],
