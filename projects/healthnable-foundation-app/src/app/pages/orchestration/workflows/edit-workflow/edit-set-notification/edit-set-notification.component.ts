...
@Component({
  selector: 'app-edit-set-notification',
  standalone: true,
  ...
  templateUrl: './edit-set-notification.component.html',
  styleUrl: './edit-set-notification.component.scss'
})
export class EditSetNotificationComponent implements OnInit{
   form!:FormGroup
  ...
  preview(){
    this.router.navigate(['/orchestration/edit-preview-workflow'] )
  }
}
